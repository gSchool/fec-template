...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  var Cart_default = class extends import_react.Component {
    constructor(props) {
      super(props);
      this.state = {
        isLoading: false
    ...
    componentDidMount() {
      ...
      fetch("api/cart_products").then((response) => response.json()).then((data) => {
        this.setState({ data, isLoading: false });
      });
    }
    render() {
      return this.state.isLoading ? /* @__PURE__ */ import_react.default.createElement("div", null, "Loading...") : /* @__PURE__ */ import_react.default.createElement("section", null, /* @__PURE__ */ import_react.default.createElement("div", null, "I am a cart"), /* @__PURE__ */ import_react.default.createElement("div", null, JSON.stringify(this.state.data)));
    }
  };

  // client/ImageGallery.jsx
  var import_react2 = __toModule(require_react());
  var ImageGallery_default = class extends import_react2.Component {
    constructor(props) {
      super(props);
      this.state = {
        isLoading: false
    ...
    componentDidMount() {
      this.setState({ isLoading: true });
      fetch("/api/product_images").then((response) => response.json()).then((data) => {
        this.setState({ data, isLoading: false });
      });
    }
    render() {
      return this.state.isLoading ? /* @__PURE__ */ import_react2.default.createElement("div", null, "Loading...") : /* @__PURE__ */ import_react2.default.createElement("section", null, /* @__PURE__ */ import_react2.default.createElement("div", null, "I am an image gallery"), /* @__PURE__ */ import_react2.default.createElement("div", null, JSON.stringify(this.state.data)));
    }
  };

  // client/Login.jsx
  var import_react3 = __toModule(require_react());
  var Login_default = class extends import_react3.Component {
    constructor(props) {
      super(props);
      this.state = {
        isLoading: false
    ...
    render() {
      return this.state.isLoading ? /* @__PURE__ */ import_react3.default.createElement("div", null, "Loading...") : /* @__PURE__ */ import_react3.default.createElement("section", null, /* @__PURE__ */ import_react3.default.createElement("div", null, "I am login"), /* @__PURE__ */ import_react3.default.createElement("div", null, JSON.stringify(this.state.data)));
    }
  };
  ...
  var App = class extends import_react4.Component {
    ...
    render() {
      return this.state.isLoading ? /* @__PURE__ */ import_react4.default.createElement("div", null, "Loading...") : /* @__PURE__ */ import_react4.default.createElement("section", null, /* @__PURE__ */ import_react4.default.createElement("div", null, "I am products"), /* @__PURE__ */ import_react4.default.createElement("div", null, JSON.stringify(this.state.data)));
    }
  };

  // client/App.jsx
  var App2 = class extends import_react5.Component {
    render() {
      return /* @__PURE__ */ import_react5.default.createElement("div", null, /* @__PURE__ */ import_react5.default.createElement(Cart_default, null), /* @__PURE__ */ import_react5.default.createElement(ImageGallery_default, null), /* @__PURE__ */ import_react5.default.createElement(Login_default, null), /* @__PURE__ */ import_react5.default.createElement(App, null));
    }
  };

  // client/index.jsx
  import_react_dom.default.render(/* @__PURE__ */ import_react6.default.createElement(App2, null), document.getElementById("root"));
})();
/*
object-assign
(c) Sindre Sorhus
